...
//let map;
let locations;
var icon = "https://www.iconpacks.net/icons/1/free-pin-icon-48-thumb.png";
function initMap() {
    ...
    $.ajax({
        url: "/CrimeCasesMap/GetCrimeCasesMap",
        type: "POST",
...
function setMarkers(map, locations) {
    ...
    for (i = 0; i < locations.length; i++) {
        ...
        var content = "<h5><a target='_blank' href='/CrimeCases'>" + title + "</a></h5>";
