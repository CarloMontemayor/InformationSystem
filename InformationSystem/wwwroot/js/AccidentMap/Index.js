...
//let map;
let locations;
var icon = "https://www.freeiconspng.com/thumbs/pin-png/pin-png-28.png";
function initMap() {
...
function setMarkers(map, locations) {
    ...
    for (i = 0; i < locations.length; i++) {
        ...
        var content = "Accident: <a target='_blank' href='/AccidentMap'><h5>" + title + '</h5></a>';
